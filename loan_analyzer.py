...
print("the total number of loans is",(total_number_of_loans)) #5
# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
total_value_of_loans = sum(loan_costs)
print("the total value of all loans is $",(total_value_of_loans)) #2750
# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
avg = sum(loan_costs)/len(loan_costs)
print("the average loan amount is $",(avg)) #550
...
present_value= calculate_present_value(future_value=1000 , remaining_months=12,annual_discount_rate=.20)
print(present_value)
